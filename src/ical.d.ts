// deno-lint-ignore-file no-var no-explicit-any ban-types
...
declare namespace helpers {
   ...
   */
  function binsearchInsert<T, T1 = T>(
    list: T[],
    seekVal: T1,
 ...
 */
declare function parse(input: string): [] | undefined;
declare namespace parse {
  var property: (str: string, designSet?: DesignSet | undefined) => never;
  var component: (str: string) => [] | undefined;
  var ParserError: {
  ...
  var _parseValue: (
    ...
    type: string,
    designSet: DesignSet,
    structuredValue?: object | undefined,
  ) => any;
  var _parseParameters: (
    line: string,
    start: number,
    designSet: DesignSet,
  ) => any[];
  var _rfc6868Escape: (val: string) => string;
  var _parseMultiValue: (
    buffer: string,
    delim: string,
    type: string,
    result: unknown[],
    ...
    designSet: DesignSet,
    structuredValue?: unknown[] | undefined,
  ) => unknown;
  var _eachLine: (
    buffer: string,
...
declare class VCardTime extends Time {
   ...
   * The type name, to be used in the jCal object.
   */
  accessor icaltype: "date-and-or-time" | "date" | "date-time";
  /**
